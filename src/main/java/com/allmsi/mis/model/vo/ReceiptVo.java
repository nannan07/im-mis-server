...
public class ReceiptVo {
    ...
    public ReceiptVo(Receipt receipt) {
    	if(receipt != null ) {
    		...
    		this.contId = receipt.getContId();
    		this.amountofThis = receipt.getAmountofThis();
    		this.receiptDate = receipt.getReceiptDate();
    		this.isArrival = receipt.getIsArrival();
    		this.invoiceSituation = receipt.getInvoiceSituation();
    		this.note = receipt.getNote();
    		this.cTime = receipt.getcTime();
    		this.uTime = receipt.getuTime();
    	}
	}
